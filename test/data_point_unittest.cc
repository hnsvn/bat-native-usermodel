...
#include "huhi/vendor/bat-native-usermodel/src/data_point.h"
#include <iostream>
#include <cmath>
...
TEST_F(DataPoint_test, Datapoint_type_assertions) {
  ...
  EXPECT_EQ(DataType::TextData, string_DataPoint.type);
  ...
  EXPECT_EQ(DataType::SparseVector, sparse_datapoint_3.type);
  ...
  EXPECT_EQ(DataType::SparseVector, sparse_datapoint_5.type);
